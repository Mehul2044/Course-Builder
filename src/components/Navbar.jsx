            ...
            <div className="flex items-center w-full justify-around">
                ...
                <DropdownMenu onOpenChange={toggleDropdown}>
                    <DropdownMenuTrigger asChild>
                        <div>
                            <Button
                                ...
                                ${theme === 'dark' || theme === "system" ? 'bg-[rgb(213,47,75)] text-white' : 'bg-[rgb(213,47,75)] text-white'}  hover:bg-[rgb(198,34,64)]`}
                    ...
                    <DropdownMenuContent
                        ...
                        <DropdownMenuItem
                            className={`hover:${theme === 'dark' || theme === "system" ? 'bg-gray-600' : 'bg-gray-300'} py-[0.6rem] text-base flex gap-2`}
